...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        public TransaccionesController(IServicioUsuarios servicioUsuarios, 
            IRepositorioCuentas repositorioCuentas, IRepositorioCategorias 
            repositorioCategorias, IRepositorioTransacciones repositorioTransacciones, 
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    return File(stream.ToArray(),
                        "applicacion/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
                        nombreArchivo);
                }
            }
        }
